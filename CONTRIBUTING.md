...
- The tool name and URL (e.g. `https://vacurim.com/tools/free-digitizer/`).
- Browser + version, OS.
- Steps to reproduce.
...
4. Test your change locally. For the free manuscript digitizer tool, verify it works in a browser.
